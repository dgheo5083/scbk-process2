 ...
 */
@Data
@IntegrationMessage(id = "CrtJctAuthorizeCertSuspensionRequest", type = Type.REQUEST)
public class CrtJctAuthorizeCertSuspensionRequest implements IMessageObject {
