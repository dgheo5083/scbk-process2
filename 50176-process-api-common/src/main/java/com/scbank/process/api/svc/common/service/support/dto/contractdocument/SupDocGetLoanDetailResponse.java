...
import com.scbank.process.api.svc.common.service.support.dto.contractdocument.SupDocGetLoanDetailRequest.Collateral;
 ...
 */
@Data
@IntegrationMessage(id = "SupDocGetLoanDetailResponse", type = Type.RESPONSE)
public class SupDocGetLoanDetailResponse implements IMessageObject {
    ...
    @MessageField(id = "yoSUTBL", name = "담보예금 계좌목록조회")
    @RepeatedField(repeatType = RepeatType.REFERENCE, repeatCount = "SupDocGetLoanDetailResponse/yoSUCNT")
    private List<Collateral> yoSUTBL;

    // @Data
    // public static class Collater implements IMessageObject {

    // @MessageField(id = "yoSUGEJ", name = "계좌번호")
    // private String yoSUGEJ;

    // @MessageField(id = "yoSUGEJ", name = "담보예금계좌번호")
