 ...
 */
@Data
@IntegrationMessage(id = "SupDocListTrustAccountResponse", type = Type.RESPONSE)
public class SupDocListTrustAccountResponse implements IMessageObject {

	@MessageField(id = "trustCommDocList", name = "예적금 계좌목록조회")
	@RepeatedField(repeatType = RepeatType.REFERENCE)
	private List<AddCntrctDocument> trustCommDocList;
