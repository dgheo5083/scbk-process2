 ...
 */
@Data
@IntegrationMessage(id = "SecRcvListPasswordErrorClearAccountResponse", type = Type.RESPONSE)
@JsonIgnoreProperties(ignoreUnknown = true)
public class SecRcvListPasswordErrorClearAccountResponse implements IMessageObject {
    ...
    @RepeatedField(repeatType = RepeatType.REFERENCE, repeatCount = "SecRcvListPasswordErrorClearAccountResponse/yoGUNSU")
    private List<YOMYINF_REC> yoMYINF_REC;

    @MessageField(id = "resultAcctList", name = "반복부")
    @RepeatedField
