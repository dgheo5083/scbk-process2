 ...
 */
@Data
@IntegrationMessage(id = "CrtFctAuthorizeOtherFincertRegRequest", type = Type.REQUEST)
public class CrtFctAuthorizeOtherFincertRegRequest implements IMessageObject {
