 ...
 */
@Data
@IntegrationMessage(id = "CrtFctValidateFincertRevokeAcctResponse", type = Type.RESPONSE)
public class CrtFctValidateFincertRevokeAcctResponse implements IMessageObject {

	@MessageField(id = "codeValue", name = "codeValue")
