 ...
 */
@Data
@IntegrationMessage(id = "CrtJctValidateCertRestoreAcctResponse", type = Type.RESPONSE)
public class CrtJctValidateCertRestoreAcctResponse implements IMessageObject {
