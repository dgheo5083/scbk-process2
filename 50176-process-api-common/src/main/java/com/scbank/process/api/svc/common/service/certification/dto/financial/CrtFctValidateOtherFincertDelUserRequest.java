 ...
 */
@Data
@IntegrationMessage(id = "CrtFctValidateOtherFincertDelUserRequest", type = Type.REQUEST)
public class CrtFctValidateOtherFincertDelUserRequest implements IMessageObject {
