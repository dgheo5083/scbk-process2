 ...
 */
@FeignClient(name = "mobileBeregCommonRoute", url = "${edmi.gateway.mobileBeregCommonRoute.baseUrl:${edmi.gateway.default.baseUrl}}", configuration = {
		com.scbank.process.api.fw.base.gateway.edmi.MBEregCommonRoute.MBEregCommonRouteConfig.class })
public interface MBEregCommonRoute {
	 ...
	 * @return EDMiResponse
	 */
	@PostMapping(path = { "${edmi.gateway.mobileBeregCommonRoute.serviceUrl:${edmi.gateway.default.serviceUrl}}" }, consumes = {
	 ...
	 * 
	 */
	public class MBEregCommonRouteRequestHeaderFilter extends EDMiRequestHeaderFilter {

		@Value("${edmi.gateway.mobileBeregCommonRoute.userName}")
	    private String userName;

	    @Value("${edmi.gateway.mobileBeregCommonRoute.credential}")
	...
	public class MBEregCommonRouteConfig extends EDMiFeignClientConfig {
		...
		EDMiRequestHeaderFilter requestTemplateFilter() {
			return new MBEregCommonRouteRequestHeaderFilter();
		}
