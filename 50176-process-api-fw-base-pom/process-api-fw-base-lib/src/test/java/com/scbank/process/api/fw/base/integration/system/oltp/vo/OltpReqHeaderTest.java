...
/**
 * Generated unit test for {@link OltpReqHeader}.
 */
class OltpReqHeaderTest {

    @Test
    void valueObjectContract() {
        OltpReqHeader a = OltpReqHeader.builder().build();
        OltpReqHeader b = OltpReqHeader.builder().build();
