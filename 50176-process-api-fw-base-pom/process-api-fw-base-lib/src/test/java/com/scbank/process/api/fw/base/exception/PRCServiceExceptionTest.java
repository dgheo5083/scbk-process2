...
/**
 * Generated unit test for {@link PRCServiceException} covering every constructor.
 */
class PRCServiceExceptionTest {

    @Test
    void causeConstructor() {
        Throwable cause = new IllegalStateException("boom");
        PRCServiceException ex = new PRCServiceException(cause);
    ...
    void frameworkErrorCodeConstructor() {
        ...
        PRCServiceException ex = new PRCServiceException(errorCode);
        assertThat(ex).isNotNull();
    }

    @Test
    void errorCodeConstructor() {
        PRCServiceException ex = new PRCServiceException("E001");
        assertThat(ex).isNotNull();
    }

    @Test
    void errorCodeAndMessageConstructor() {
        PRCServiceException ex = new PRCServiceException("E001", "message");
        assertThat(ex).isNotNull();
    }

    @Test
    void errorCodeAndCauseConstructor() {
        PRCServiceException ex = new PRCServiceException("E001", new RuntimeException());
        assertThat(ex).isNotNull();
    }

    @Test
    void errorCodeMessageAndCauseConstructor() {
        PRCServiceException ex = new PRCServiceException("E001", "message", new RuntimeException());
        assertThat(ex).isNotNull();
    }
    ...
    void errorCodeAndMessageArgsConstructor() {
        ...
        args.add("arg");
        PRCServiceException ex = new PRCServiceException("E001", args);
        assertThat(ex).isNotNull();
    }
    ...
    void errorCodeMessageArgsAndCauseConstructor() {
        List<Object> args = new ArrayList<>();
        args.add("arg");
        PRCServiceException ex = new PRCServiceException("E001", args, new RuntimeException());
        assertThat(ex).isNotNull();
    }
}
