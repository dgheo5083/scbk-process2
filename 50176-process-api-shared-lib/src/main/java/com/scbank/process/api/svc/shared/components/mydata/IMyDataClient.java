...
public interface IMyDataClient {
	...
	public static final String ERR_MA001 = "MYDATA-MA001";
	public static final String ERR_MA001_MSG = "JSON DATA를 확인해 주세요.";
	public static final String ERR_MA002 = "MYDATA-MA002";
	public static final String ERR_MA002_MSG = "RESPONSE DATA NOT FOUND";
	public static final String ERR_MA003 = "MYDATA-MA003";
	public static final String ERR_MA003_MSG = "해당 경로가 존재하지 않습니다.";
	public static final String ERR_MA004 = "MYDATA-MA004";
	public static final String ERR_MA004_MSG = "연동 정보가 유효하지 않습니다.";
	public static final String ERR_MA005 = "MYDATA-MA005";
	...
	default MyDataHttpResponseEntity execute(MyDataHttpRequestEntity entity) {
		return null;
	}
}
