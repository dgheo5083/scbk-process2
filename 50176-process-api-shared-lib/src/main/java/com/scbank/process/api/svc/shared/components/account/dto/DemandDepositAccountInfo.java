...
@Data
@IntegrationMessage(id = "DemandDepositAccountInfo", type = Type.RESPONSE, description = "예금 계좌목록조회 응답")
public class DemandDepositAccountInfo implements IMessageObject {
