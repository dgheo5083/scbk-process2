...
@Data
@IntegrationMessage(id = "PensionTrustAccountInfo", type = Type.RESPONSE, description = "연금신탁 계좌목록조회 응답")
public class PensionTrustAccountInfo implements IMessageObject {
    ...
    @MessageField(id = "drawAcctNameAlias", name = "계좌별칭")
    ...
    @MessageField(id = "accountDisplay", name = "")
