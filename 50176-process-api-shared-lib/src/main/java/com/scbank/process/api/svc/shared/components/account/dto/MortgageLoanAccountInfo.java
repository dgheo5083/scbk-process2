...
@Data
@IntegrationMessage(id = "MortgageLoanAccountInfo", type = Type.RESPONSE, description = "예적금 계좌목록조회 응답")
public class MortgageLoanAccountInfo implements IMessageObject {
