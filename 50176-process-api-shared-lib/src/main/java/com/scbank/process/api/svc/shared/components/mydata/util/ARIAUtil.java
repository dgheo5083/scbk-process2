 ...
 * @Class Name : ARIAUtil.java
 * @Description : ARIA CBC모드 및 PKCS7패팅 적용
 * @Author : EKW
 * @Since : 2020. 12. 11. 오후 12:39:28
 */
public class ARIAUtil {
	...
	public byte[] encrypt(byte[] plan) throws Exception {
		...
		if (plan.length % BLOCK_LENGTH != 0) {
			...
			encLength = plan.length + BLOCK_LENGTH;
		}
