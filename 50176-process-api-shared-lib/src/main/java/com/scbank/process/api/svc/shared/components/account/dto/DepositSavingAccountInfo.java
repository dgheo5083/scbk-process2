...
@Data
@IntegrationMessage(id = "DepositSavingAccountInfo", type = Type.RESPONSE, description = "예적금(10,20,30,80,85,88,90) 계좌목록조회 응답")
public class DepositSavingAccountInfo implements IMessageObject {
