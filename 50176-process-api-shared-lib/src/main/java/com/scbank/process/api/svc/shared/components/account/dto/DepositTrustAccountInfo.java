...
@Data
@IntegrationMessage(id = "DepositTrustAccountInfo", type = Type.RESPONSE, description = "예적금 및 신탁 계좌목록조회 응답")
public class DepositTrustAccountInfo implements IMessageObject {
