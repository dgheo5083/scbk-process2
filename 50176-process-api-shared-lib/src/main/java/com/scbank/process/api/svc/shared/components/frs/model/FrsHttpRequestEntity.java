 ...
 * 금결원 안면인식 요청 Entity
 */
public class FrsHttpRequestEntity {
	...
	private IFrsClientInterceptor interceptor;
	...
	public IFrsClientInterceptor getInterceptor() {
		return interceptor;
	}

	public void setInterceptor(IFrsClientInterceptor interceptor) {
		this.interceptor = interceptor;
	}

	@Override
	public String toString() {
		return "FrsHttpRequestEntity [url=" + url + ", accessToken=" + accessToken + ", method=" + method + ", option=" + option + ", headers=" + headers + ", bodyParameters=" + bodyParameters + "]";
	}
