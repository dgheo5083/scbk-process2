...
@Data
@IntegrationMessage(id = "PaymentNormalAccountInfo", type = Type.RESPONSE, description = "출금(10,20,30 계좌만) 계좌목록조회 응답")
public class PaymentNormalAccountInfo implements IMessageObject {
    ...
    @MessageField(id = "drawYn", name = "출금계좌여부", defaultValue = "N")
    private String drawYn;

    @MessageField(id = "drawBnkCd", name = "은행코드")
    private String drawBnkCd;

    @MessageField(id = "drawBnkNm", name = "은행명")
    private String drawBnkNm;
