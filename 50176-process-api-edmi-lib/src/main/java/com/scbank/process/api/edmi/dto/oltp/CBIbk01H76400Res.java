...
@Getter
@Setter
@IntegrationMessage(id = "CBIbk01H76400Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "모바일OTP 가입 및 해지 조회 응답 전문")
public class CBIbk01H76400Res implements IMessageObject {
