...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk03H43700Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "정기예적금 조회 응답 전문")
public class CbIbk03H43700Res implements IMessageObject {
