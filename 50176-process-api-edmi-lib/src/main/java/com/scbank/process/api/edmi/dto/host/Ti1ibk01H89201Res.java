...
@Getter
@Setter
@IntegrationMessage(id = "Ti1ibk01H89201Res", type = Type.RESPONSE, description = "아이디찾기 응답 전문")
public class Ti1ibk01H89201Res implements IMessageObject {

	@MessageField(id = "UserID", name = "이용자번호", length = 10)
	private String UserID;

	@MessageField(id = "UserID2", name = "실제이용자번호", length = 10)
	...
	@MessageField(id = "CustName", name = "고객명", length = 32, masking = true, maskingType = "04")
	...
	@MessageField(id = "DUMMY", name = "더미", length = 30)
