...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H92C01Req", type = Type.REQUEST, captureSystem = "OLTP", description = "고객정보 변경등록 전문")
public class CbIbk01H92C01Req implements IMessageObject {
	...
	@MessageField(id = "YICMFNA", name = "H고객명", length = 32, masking = true, maskingType = "04", sosi = true)
	...
	@MessageField(id = "YIJUSO4", name = "상세", length = 100, masking = true, maskingType = "06", multiBytes = true)
	...
	@MessageField(id = "YIJUSO5", name = "YIJUSO5", length = 100, masking = true, maskingType = "06", multiBytes = true)
	...
	@MessageField(id = "YIOFINA", name = "H직장명", length = 30, multiBytes = true)
	private String YIOFINA;

	@MessageField(id = "YIDPTNA", name = "H부서명", length = 30, multiBytes = true)
	private String YIDPTNA;

	@MessageField(id = "YIJWINA1", name = "H직위명1", length = 10, multiBytes = true)
	...
	@MessageField(id = "YIENAYN", name = "영문명수기입력여부 Y:직접입력, N:네이버API", length = 1)
	private String YIENAYN;

	@MessageField(id = "YIENAME", name = "네이버영문명", length = 50)
	private String YIENAME;

	@MessageField(id = "YIJOBDEL", name = "직장정보삭제여부", length = 1)
