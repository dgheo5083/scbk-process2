...
@Getter
@Setter
@IntegrationMessage(id = "CbTbs03D91500Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "인터넷뱅킹해지 응답부")
public class CbTbs03D91500Res implements IMessageObject {
