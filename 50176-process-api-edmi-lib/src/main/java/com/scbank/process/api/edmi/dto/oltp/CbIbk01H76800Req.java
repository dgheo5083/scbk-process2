...
@NoArgsConstructor
@AllArgsConstructor
@IntegrationMessage(id = "CbIbk01H76800Req", type = Type.REQUEST, captureSystem = "OLTP", description = "만기자동입금,재예치 조회.신청.해제 요청부")
public class CbIbk01H76800Req implements IMessageObject {
