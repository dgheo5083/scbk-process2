...
@Getter
@Setter
@IntegrationMessage(id = "Ti1ibk01H92CReq", type = Type.REQUEST, captureSystem = "OLTP", description = "고객정보조회 요청 전문")
public class Ti1ibk01H92CReq implements IMessageObject {
    ...
    @MessageField(id = "YICMFNAHs", name = "H고객명 시작", length = 1)
    private String YICMFNAHs;

    @MessageField(id = "YICMFNA", name = "H고객명 시작", length = 30, masking = true, maskingType = "04")
    private String YICMFNA;

    @MessageField(id = "YICMFNAHe", name = "H고객명 종료", length = 1)
    private String YICMFNAHe;
    ...
    @MessageField(id = "YIHMJSO1Hs", name = "H자택주소1 시작", length = 1)
    private String YIHMJSO1Hs;

    @MessageField(id = "YIHMJSO1", name = "H자택주소1", length = 40, masking = true, maskingType = "06")
    private String YIHMJSO1;

    @MessageField(id = "YIHMJSO1He", name = "H자택주소1 종료", length = 1)
    private String YIHMJSO1He;

    @MessageField(id = "YIHMJSO2Hs", name = "H자택주소2 시작", length = 1)
    private String YIHMJSO2Hs;

    @MessageField(id = "YIHMJSO2", name = "H자택주소2", length = 60)
    private String YIHMJSO2;

    @MessageField(id = "YIHMJSO2He", name = "H자택주소2 종료", length = 1)
    private String YIHMJSO2He;
    ...
    @MessageField(id = "YIOFIJSO1Hs", name = "H직장주소1 시작", length = 1)
    private String YIOFIJSO1Hs;

    @MessageField(id = "YIOFIJSO1", name = "H직장주소1", length = 40, masking = true, maskingType = "06")
    private String YIOFIJSO1;

    @MessageField(id = "YIOFIJSO1He", name = "H직장주소1 종료", length = 1)
    private String YIOFIJSO1He;

    @MessageField(id = "YIOFIJSO2Hs", name = "H직장주소2 시작", length = 1)
    private String YIOFIJSO2Hs;

    @MessageField(id = "YIOFIJSO2", name = "H직장주소2", length = 60, masking = true, maskingType = "06")
    private String YIOFIJSO2;

    @MessageField(id = "YIOFIJSO2He", name = "H직장주소2 종료", length = 1)
    private String YIOFIJSO2He;
