...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H504Req", type = Type.REQUEST, captureSystem = "OLTP", description = "개인정보노출자 조회 요청 전문")
public class CbIbk01H504Req implements IMessageObject {
