...
@Data
@IntegrationMessage(id = "CbTbs07H42100Req", type = Type.REQUEST, captureSystem = "OLTP", description = "자동이체 신청 요청부")
public class CbTbs07H42100Req implements IMessageObject {
    ...
    @MessageField(id = "HgSNameSO1", name = "송금인명한글시작1", length = 1, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String HgSNameSO1;

    @MessageField(id = "HgSName", name = "송금인명", length = 20, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String HgSName;

    @MessageField(id = "HgSNameSI1", name = "송금인명한글끝1", length = 1, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String HgSNameSI1;

    @MessageField(id = "HgRNameSO2", name = "수취인명한글시작2", length = 1, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String HgRNameSO2;

    @MessageField(id = "HgRName", name = "수취인명", length = 20, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String HgRName;

    @MessageField(id = "HgRNameSI2", name = "수취인명한글끝2", length = 1, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String HgRNameSI2;

    @MessageField(id = "YIJUKYOSO3", name = "출금통장표시내역한글시작3", length = 1, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String YIJUKYOSO3;

    @MessageField(id = "YIJUKYO", name = "출금통장표시내역", length = 20, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String YIJUKYO;

    @MessageField(id = "YIJUKYOSI3", name = "출금통장표시내역한글끝3", length = 1, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String YIJUKYOSI3;

    @MessageField(id = "YIJUKIPSO4", name = "입금통장표시내역한글시작4", length = 1, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String YIJUKIPSO4;

    @MessageField(id = "YIJUKIP", name = "입금통장표시내역", length = 20, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String YIJUKIP;

    @MessageField(id = "YIJUKIPSI4", name = "입금통장표시내역한글끝4", length = 1, align = AlignType.LEFT, padding = StringUtils.SPACE)
