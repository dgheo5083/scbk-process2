...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H11402Res", type = Type.RESPONSE, description = "잔액 조회(신탁)")
public class CbIbk01H11402Res implements IMessageObject {
	...
	@MessageField(id = "PromiseDueDate", name = "약정기일", length = 8, align = AlignType.LEFT, padding = StringUtils.SPACE)
	private String PromiseDueDate;

	@MessageField(id = "RevoDueDate", name = "회전기일", length = 8, align = AlignType.LEFT, padding = StringUtils.SPACE)
	...
	@MessageField(id = "FinalTrxDate", name = "최종거래일자", length = 8, align = AlignType.RIGHT, padding = StringUtils.SPACE)
	...
	@MessageField(id = "YOWBIL1", name = "적립만료일", length = 8, align = AlignType.LEFT, padding = StringUtils.SPACE)
