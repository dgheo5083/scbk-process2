...
@Data
@IntegrationMessage(id = "CbTbs07D93201Req", type = Type.REQUEST, captureSystem = "OLTP", description = "신용카드사고신고등록 요청부")
public class CbTbs07D93201Req implements IMessageObject {
