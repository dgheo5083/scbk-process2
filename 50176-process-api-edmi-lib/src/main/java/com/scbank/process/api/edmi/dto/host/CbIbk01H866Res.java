...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H866Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "보유계좌조회 응답 전문")
public class CbIbk01H866Res implements IMessageObject {
	...
	@RepeatedField(repeatType = RepeatType.REFERENCE, repeatCount = "CbIbk01H866Res/YOGUNSU")
