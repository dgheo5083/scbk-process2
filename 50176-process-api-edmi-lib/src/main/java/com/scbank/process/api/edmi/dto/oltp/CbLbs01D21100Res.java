...
@Getter
@Setter
@IntegrationMessage(id = "CbLbs01D21100Res", type = Type.RESPONSE, description = "즉시이체 본거래 응답 전문")
public class CbLbs01D21100Res implements IMessageObject {
    ...
    @RepeatedField(repeatType = RepeatType.REFERENCE, repeatCount = "CbLbs01D21100Res/Rcount")
