...
@NoArgsConstructor
@AllArgsConstructor
@IntegrationMessage(id = "CbIbk01D93600Req", type = Type.REQUEST, description = "지연이체 서비스 신청 및 해지 요청 전문", captureSystem = "OLTP")
public class CbIbk01D93600Req implements IMessageObject {
