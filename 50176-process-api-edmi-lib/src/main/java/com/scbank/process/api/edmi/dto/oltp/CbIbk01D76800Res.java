...
@NoArgsConstructor
@AllArgsConstructor
@IntegrationMessage(id = "CbIbk01D76800Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "만기자동입금,재예치 조회.신청.해제 응답부")
public class CbIbk01D76800Res implements IMessageObject {
