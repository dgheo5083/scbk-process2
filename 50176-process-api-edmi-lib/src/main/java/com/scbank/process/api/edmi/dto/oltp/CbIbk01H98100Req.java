...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H98100Req", type = Type.REQUEST, captureSystem = "OLTP", description = "세금계산서 여부 및 메일발송 요청 전문")
public class CbIbk01H98100Req implements IMessageObject {
    ...
    @MessageField(id = "TelCode3", name = "전화번호3", length = 4, masking = true, maskingType = "03")
    ...
    @MessageField(id = "TypesOfIndustry", name = "업종", length = 18, align = AlignType.LEFT, sosi = true)
    private String TypesOfIndustry;

    @MessageField(id = "Item", name = "종목", length = 18, align = AlignType.LEFT, sosi = true)
    private String Item;
    ...
    @MessageField(id = "Dummy0", name = "dummy0", length = 223)
