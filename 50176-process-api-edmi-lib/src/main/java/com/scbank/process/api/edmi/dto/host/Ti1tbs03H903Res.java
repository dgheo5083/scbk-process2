...
@Getter
@Setter
@IntegrationMessage(id = "Ti1tbs03H903Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "모바일OTP 비밀키, 랜덤질의값 조회 응답 전문")
public class Ti1tbs03H903Res implements IMessageObject {
