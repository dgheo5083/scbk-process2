...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H23100Req", type = Type.REQUEST, captureSystem = "OLTP", description = "대출금이자 상환 요청부")
public class CbIbk01H23100Req implements IMessageObject {
