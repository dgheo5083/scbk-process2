...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01D85A00Req", type = Type.REQUEST, captureSystem = "OLTP", description = "서비스해지 본거래 요청부")
public class CbIbk01D85A00Req implements IMessageObject {
