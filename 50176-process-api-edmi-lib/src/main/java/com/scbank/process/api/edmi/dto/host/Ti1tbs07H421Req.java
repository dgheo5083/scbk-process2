...
@Data
@IntegrationMessage(id = "Ti1tbs07H421Req", type = Type.REQUEST, description = "당행 자동이체 신청 요청부")
public class Ti1tbs07H421Req implements IMessageObject {
	...
	@MessageField(id = "HgSName", name = "송금인명", length = 22, align = AlignType.LEFT)
	...
	@MessageField(id = "HgRName", name = "수취인명", length = 22, align = AlignType.LEFT)
	...
	@MessageField(id = "YIJUKYO", name = "출금통장표시내역", length = 22, align = AlignType.LEFT, sosi = true)
	...
	@MessageField(id = "YIJUKIP", name = "입금통장표시내역", length = 22, align = AlignType.LEFT, sosi = true)
