...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H981Req", type = Type.REQUEST, captureSystem = "OLTP", description = "세금계산서 여부 및 메일발송 요청 전문")
public class CbIbk01H981Req implements IMessageObject {
