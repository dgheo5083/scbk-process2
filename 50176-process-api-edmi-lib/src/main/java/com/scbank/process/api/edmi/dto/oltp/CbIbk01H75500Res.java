...
@NoArgsConstructor
@AllArgsConstructor
@IntegrationMessage(id = "CbIbk01H75500Res", type = Type.RESPONSE, description = "인터넷담보대출허용 응답 전문", captureSystem = "OLTP")
public class CbIbk01H75500Res implements IMessageObject {
