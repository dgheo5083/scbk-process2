...
@Data
@IntegrationMessage(id = "RiskCddRegisterMbRes", type = Type.RESPONSE, description = "KCDD고객자동화 처리 상태조회 응답부[AS-IS EDMI_RISK_CddStatus_MB]")
public class RiskCddStatusMbRes implements IMessageObject {
	/**
	 * 
	 */
	...
	@MessageField(id = "CRA_GRADE", name = "CRA등급", length = 1)
