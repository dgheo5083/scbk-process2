...
@NoArgsConstructor
@AllArgsConstructor
@IntegrationMessage(id = "CbIbk01D22900Res", type = Type.RESPONSE, description = "등록된 예약이체 조회 응답 전문")
public class CbIbk01D22900Res implements IMessageObject {
    ...
    @RepeatedField(repeatType = RepeatType.REFERENCE, repeatCount = "CbIbk01D22900Res/RCount")
