...
@Getter
@Setter
@IntegrationMessage(id = "Ti1ibk01H980Req", type = Type.REQUEST, captureSystem = "OLTP", description = "타행타기관인증서목록 요청 전문")
public class Ti1ibk01H980Req implements IMessageObject {
