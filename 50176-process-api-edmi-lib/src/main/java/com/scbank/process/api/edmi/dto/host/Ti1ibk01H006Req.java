...
@Getter
@Setter
@IntegrationMessage(id = "Ti1ibk01H006Req", type = Type.REQUEST, captureSystem = "OLTP", description = "본인확인 요청 전문")
public class Ti1ibk01H006Req implements IMessageObject {
