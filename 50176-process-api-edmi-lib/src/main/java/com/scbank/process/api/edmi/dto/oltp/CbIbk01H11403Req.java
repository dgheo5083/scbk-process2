...
@NoArgsConstructor
@AllArgsConstructor
@IntegrationMessage(id = "CbIbk01H11403Req", type = Type.REQUEST, description = "정기예금상세조회 요청부", captureSystem = "OLTP")
public class CbIbk01H11403Req implements IMessageObject {
    ...
    @MessageField(id = "TeleThree", name = "전화번호", length = 4, align = AlignType.RIGHT, padding = StringUtils.ZERO)
