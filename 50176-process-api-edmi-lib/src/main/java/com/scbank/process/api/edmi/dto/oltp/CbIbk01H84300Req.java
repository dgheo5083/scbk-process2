...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H84300Req", type = Type.REQUEST, captureSystem = "OLTP", description = "CI조회 요청 전문")
public class CbIbk01H84300Req implements IMessageObject {
