...
@Getter
@Setter
@IntegrationMessage(id = "CbTbs03H90400Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "모바일OTP 재발급 예비/본처리 응답 전문")
public class CbTbs03H90400Res implements IMessageObject {
