...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H980Req", type = Type.REQUEST, captureSystem = "OLTP", description = "타행타기관인증서목록 요청 전문")
public class CbIbk01H980Req implements IMessageObject {
