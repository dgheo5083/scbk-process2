...
@Getter
@Setter
@IntegrationMessage(id = "Ti1tbs03H903Req", type = Type.REQUEST, captureSystem = "OLTP", description = "모바일OTP 비밀키, 랜덤질의값 조회 요청 전문")
public class Ti1tbs03H903Req implements IMessageObject {
