...
@Getter
@Setter
@IntegrationMessage(id = "Ti1ibk01H722Res", type = Type.RESPONSE, description = "펀드 통장상세조회 응답부")
public class Ti1ibk01H722Res implements IMessageObject {
	...
	@MessageField(id="YOONAME",name="고객명",length=34,masking=true,maskingType="04",align=AlignType.LEFT,padding=StringUtils.SPACE)
	...
	private String YOMIJGAK;

	@MessageField(id="YOYGGJNO",name="환매연결계좌번호",length=11,masking=true,maskingType="02",align=AlignType.RIGHT,padding=StringUtils.ZERO)
