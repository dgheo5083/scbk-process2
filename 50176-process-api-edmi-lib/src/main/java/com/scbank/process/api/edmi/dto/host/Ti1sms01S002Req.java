...
@Getter
@Setter
@IntegrationMessage(id = "Ti1sms01S002Req", type = Type.REQUEST, captureSystem = "OLTP", description = "완료시 SMS발송 요청 전문")
public class Ti1sms01S002Req implements IMessageObject {
