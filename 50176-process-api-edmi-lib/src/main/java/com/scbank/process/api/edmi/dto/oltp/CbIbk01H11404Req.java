...
@NoArgsConstructor
@AllArgsConstructor
@IntegrationMessage(id = "CbIbk01H11404Req", type = Type.REQUEST, description = "잔액조회(외환) 요청부", captureSystem = "OLTP")
public class CbIbk01H11404Req implements IMessageObject {
