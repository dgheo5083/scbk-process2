...
@Getter
@Setter
@IntegrationMessage(id = "CbTbs03H90400Req", type = Type.REQUEST, captureSystem = "OLTP", description = "모바일OTP 재발급 예비/본처리 요청 전문")
public class CbTbs03H90400Req implements IMessageObject {
