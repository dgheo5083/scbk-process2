...
@Setter
@ToString
@IntegrationMessage(id = "MciIbFep01001Req", type = Type.REQUEST, description = "해외출입국 여부 확인 요청부")
public class MciIbFep01001Req implements IMessageObject {
    ...
    @MessageField(id = "RES_CD", name = "응답코드", length = 3)
    private String RES_CD;

    @MessageField(id = "ABROAD_YN", name = "출국여부코드", length = 2)
