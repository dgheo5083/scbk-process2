...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01D85200Req", type = Type.REQUEST, captureSystem = "OLTP", description = "서비스정지 요청부")
public class CbIbk01D85200Req implements IMessageObject {
