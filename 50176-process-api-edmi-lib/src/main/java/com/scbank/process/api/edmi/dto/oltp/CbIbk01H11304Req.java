...
@NoArgsConstructor
@AllArgsConstructor
@IntegrationMessage(id = "CbIbk01H11304Req", type = Type.REQUEST, captureSystem = "OLTP", description = "입출금명세조회_적립식 요청부")
public class CbIbk01H11304Req implements IMessageObject {
    ...
    @MessageField(id = "PerNo", name = "", length = 13, masking = true, maskingType = "01", align = AlignType.LEFT, padding = StringUtils.SPACE)
