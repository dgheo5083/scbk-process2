...
@Getter
@Setter
@IntegrationMessage(id = "Ti1ibk01H89201Req", type = Type.REQUEST, captureSystem = "OLTP", description = "아이디찾기 요청 전문")
public class Ti1ibk01H89201Req implements IMessageObject {

	@MessageField(id = "UserID", name = "이용자번호", length = 10)
	private String UserID;

	@MessageField(id = "CustJumin1", name = "주민사업자번호 앞번호", length = 6)
	private String CustJumin1;

	@MessageField(id = "CustJumin2", name = "주민사업자번호 뒷번호", length = 7, masking = true, maskingType = "01")
