...
@IntegrationMessage(id = "CbIbk01H11306Req", type = Type.REQUEST, captureSystem = "OLTP", description = "신탁거래내역조회 요청부")
public class CbIbk01H11306Req implements IMessageObject {
