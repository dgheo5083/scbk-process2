...
@Getter
@Setter
@IntegrationMessage(id = "CbTbs03H44200Req", type = Type.REQUEST, captureSystem = "OLTP", description = "펀드 환매신청 예비/본거래")
public class CbTbs03H44200Req implements IMessageObject {
