...
@Getter
@Setter
@IntegrationMessage(id = "CbTbs03D22100Res", type = Type.RESPONSE, description = "즉시이체 본거래 응답 전문")
public class CbTbs03D22100Res implements IMessageObject {
    ...
    @MessageField(id = "TR211Rec1", name = "접수번호별 record")
    @RepeatedField(repeatType = RepeatType.REFERENCE, repeatCount = "CbTbs03D21100Res/Rcount")
