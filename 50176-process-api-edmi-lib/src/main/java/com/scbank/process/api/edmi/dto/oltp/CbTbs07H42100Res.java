...
@Data
@IntegrationMessage(id = "CbTbs07H42100Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "자동이체 신청 응답부")
public class CbTbs07H42100Res implements IMessageObject {
