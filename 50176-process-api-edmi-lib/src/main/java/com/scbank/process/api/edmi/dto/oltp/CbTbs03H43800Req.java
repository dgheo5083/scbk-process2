...
@Getter
@Setter
@IntegrationMessage(id = "CbTbs03H43800Req", type = Type.REQUEST, captureSystem = "OLTP", description = "입출금계좌 조회 및 해지 정보 조회 요청 전문")
public class CbTbs03H43800Req implements IMessageObject {
    ...
    @MessageField(id = "CloseAcctPasswd", name = "해약계좌비번호", length = 4, align = AlignType.RIGHT, padding = StringUtils.ZERO, masking = true, maskingType = "03")
    private String CloseAcctPasswd; // APP 이중암호화 대응 _DNFE2E_ _/DNFE2E_, WEB 이중암호화 대응 _DVKEY_ _/DVKEY_
    ...
    @MessageField(id = "Dummy", name = "dummy", length = 343, align = AlignType.LEFT, padding = StringUtils.SPACE)
