...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H98100Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "세금계산서 여부 및 메일발송 응답 전문")
public class CbIbk01H98100Res implements IMessageObject {
    ...
    @MessageField(id = "DeptPersonName", name = "DeptPersonName", length = 32, masking = true, maskingType = "04", multiBytes = true)
