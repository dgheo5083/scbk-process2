...
@NoArgsConstructor
@AllArgsConstructor
@IntegrationMessage(id = "CbIbk01H86600Req", type = Type.REQUEST, captureSystem = "OLTP", description = "보유계좌조회 요청 전문")
public class CbIbk01H86600Req implements IMessageObject {

    @MessageField(id = "UserID", name = "이용자번호", length = 10)
    private String UserID;

    @MessageField(id = "TSPassword", name = "통신비밀번호", length = 8, masking = true, maskingType = "03", encoding = "cp500", align = AlignType.LEFT, padding = StringUtils.SPACE)
