...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H00601Req", type = Type.REQUEST, captureSystem = "OLTP", description = "본인확인2 요청 전문")
public class CbIbk01H00601Req implements IMessageObject {
