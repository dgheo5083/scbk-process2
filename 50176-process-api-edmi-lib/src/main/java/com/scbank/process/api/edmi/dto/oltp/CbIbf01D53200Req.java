...
@Getter
@Setter
@IntegrationMessage(id = "CbIbf01D53200Req", type = Type.REQUEST, captureSystem = "OLTP", description = "외화정기예금조회해지 본거래 요청 전문")
public class CbIbf01D53200Req implements IMessageObject {
