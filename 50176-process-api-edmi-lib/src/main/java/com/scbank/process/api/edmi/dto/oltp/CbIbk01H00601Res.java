...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H00601Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "본인확인2 응답 전문")
public class CbIbk01H00601Res implements IMessageObject {
