...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H11300Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "펀드 입출금명세조회 응답부")
public class CbIbk01H11300Res implements IMessageObject {
    ...
    @RepeatedField(repeatType = RepeatType.REFERENCE, repeatCount = "CbIbk01H11300Res/Rcount")
