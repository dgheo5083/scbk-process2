...
@NoArgsConstructor
@AllArgsConstructor
@IntegrationMessage(id = "CbIbk01H11400Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "계좌상세조회 응답부")
public class CbIbk01H11400Res implements IMessageObject {
    ...
    @MessageField(id = "YOHDAK1", name = "한도금액 생계비통장", length = 13, align = AlignType.RIGHT, padding = StringUtils.SPACE)
    private BigDecimal YOHDAK1;
