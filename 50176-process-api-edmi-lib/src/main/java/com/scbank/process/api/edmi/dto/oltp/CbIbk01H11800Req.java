...
@NoArgsConstructor
@AllArgsConstructor
@IntegrationMessage(id = "CbIbk01H11800Req", type = Type.REQUEST, captureSystem = "OLTP", description = "해지예상조회 요청부")
public class CbIbk01H11800Req implements IMessageObject {
