...
@Data
@IntegrationMessage(id = "CbTbs03H93500Res", type = Type.RESPONSE, description = "입금지정계좌")
public class CbTbs03H93500Res implements IMessageObject {
    ...
    @RepeatedField(repeatType = RepeatType.REFERENCE, repeatCount = "CbTbs03H93500Res/YOMSSU")
