...
@Getter
@Setter
@IntegrationMessage(id = "CbTbs03H21100Req", type = Type.REQUEST, description = "즉시이체 요청 전문", captureSystem = "OLTP")
public class CbTbs03H21100Req implements IMessageObject {
    ...
    // @MessageField(id = "IgBankName", name = "입금은행명", length = 6, align =
    ...
    // @MessageField(id = "HgRNameSO2", name = "출금통장표시내용 한글시작", length = 1)
