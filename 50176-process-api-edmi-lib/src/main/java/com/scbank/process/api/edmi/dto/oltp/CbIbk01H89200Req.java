...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H89200Req", type = Type.REQUEST, captureSystem = "OLTP", description = "아이디찾기 요청 전문")
public class CbIbk01H89200Req implements IMessageObject {
