...
@NoArgsConstructor
@AllArgsConstructor
@IntegrationMessage(id = "CbIbk01H11401Req", type = Type.REQUEST, description = "출금계좌비밀번호 검증 요청 전문")
public class CbIbk01H11401Req implements IMessageObject {
    ...
    @MessageField(id = "AcctPassword", name = "계좌비밀번호", length = 4, masking = true, maskingType = "03", padding = StringUtils.ZERO, align = AlignType.RIGHT)
