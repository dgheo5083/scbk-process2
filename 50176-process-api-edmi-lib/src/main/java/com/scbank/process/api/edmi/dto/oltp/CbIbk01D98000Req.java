...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01D98000Req", type = Type.REQUEST, captureSystem = "OLTP", description = "타행타기관인증서목록 요청 전문")
public class CbIbk01D98000Req implements IMessageObject {
