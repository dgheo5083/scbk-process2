...
@Getter
@Setter
@IntegrationMessage(id = "Ti1ibk01H92CRes", type = Type.RESPONSE, captureSystem = "OLTP", description = "고객정보조회 응답 전문")
public class Ti1ibk01H92CRes implements IMessageObject {
    ...
    @RepeatedField(repeatType = RepeatType.REFERENCE, repeatCount = "Ti1ibk01H92CRes/YOGUNSU")
    ...
    @RepeatedField(repeatType = RepeatType.REFERENCE, repeatCount = "Ti1ibk01H92CRes/YOMSSU")
