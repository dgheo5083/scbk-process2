...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H981Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "세금계산서 여부 및 메일발송 응답 전문")
public class CbIbk01H981Res implements IMessageObject {
