...
@Data
@IntegrationMessage(id = "CbTbs03D90200Req", type = Type.REQUEST, captureSystem = "OLTP", description = "온라인OTP 분실신고해제 거래 요청부")
public class CbTbs03D90200Req implements IMessageObject {
