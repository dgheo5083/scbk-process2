...
@Data
@IntegrationMessage(id = "CbIbk01H93001Req", type = Type.REQUEST, captureSystem = "OLTP", description = "사고신고등록 요청부")
public class CbIbk01H93001Req implements IMessageObject {
