...
@Getter
@Setter
@IntegrationMessage(id = "CbTbs03H93800Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "이체기능재사용 응답부")
public class CbTbs03H93800Res implements IMessageObject {
