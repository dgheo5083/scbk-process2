...
@Getter
@Setter
@IntegrationMessage(id = "CbIbf01H53200Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "외화정기예금조회해지")
public class CbIbf01H53200Res implements IMessageObject {
