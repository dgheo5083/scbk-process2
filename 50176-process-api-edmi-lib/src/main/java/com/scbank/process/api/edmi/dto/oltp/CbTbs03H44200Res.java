...
@Getter
@Setter
@IntegrationMessage(id = "CbTbs03H44200Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "펀드 환매신청 예비/본거래")
public class CbTbs03H44200Res implements IMessageObject {
