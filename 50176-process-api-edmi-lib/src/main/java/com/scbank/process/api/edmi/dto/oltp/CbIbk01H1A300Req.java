...
@AllArgsConstructor
@NoArgsConstructor
@IntegrationMessage(id = "CbIbk01H1A300Req", type = Type.REQUEST, description = "펀드 입출금명세조회", captureSystem = "OLTP")
public class CbIbk01H1A300Req implements IMessageObject {
    @MessageField(id = "UserID", name = "이용자번호", length = 10, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String UserID;

    @MessageField(id = "TSPassword", name = "통신비밀번호", length = 8, align = AlignType.LEFT, padding = StringUtils.SPACE)
    ...
    @MessageField(id = "AcctPassword", name = "계좌비밀번호", length = 4, masking = true, maskingType = "03", align = AlignType.LEFT, padding = StringUtils.SPACE)
