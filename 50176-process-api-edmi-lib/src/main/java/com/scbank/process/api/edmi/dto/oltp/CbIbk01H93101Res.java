...
@Data
@IntegrationMessage(id = "CbIbk01H93101Res", type = Type.RESPONSE, description = "직불현금카드사고신고 응답부")
public class CbIbk01H93101Res implements IMessageObject {
    ...
    @RepeatedField(repeatType = RepeatType.REFERENCE, repeatCount = "CbIbk01H93101Res/RCount")
