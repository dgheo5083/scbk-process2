...
@Getter
@Setter
@IntegrationMessage(id = "Ti1ibk01H892Res", type = Type.RESPONSE, description = "아이디찾기 응답 전문")
public class Ti1ibk01H892Res implements IMessageObject {

	@MessageField(id = "UserID", name = "이용자번호", length = 10, multiBytes = true)
	private String UserID;

	@MessageField(id = "UserID2", name = "실제이용자번호", length = 10, multiBytes = true)
