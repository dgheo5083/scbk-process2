...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H73600Req", type = Type.REQUEST, captureSystem = "OLTP", description = "증명서>원천징수영수증-년도별금융소득정보조회")
public class CbIbk01H73600Req implements IMessageObject {
