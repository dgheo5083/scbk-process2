...
@Getter
@Setter
@IntegrationMessage(id = "Ti1tbs03H201Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "보안매체 검증처리 응답부")
public class Ti1tbs03H201Res implements IMessageObject {
