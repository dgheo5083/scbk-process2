...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk03H43700Req", type = Type.REQUEST, captureSystem = "OLTP", description = "정기예적금 조회 요청 전문")
public class CbIbk03H43700Req implements IMessageObject {
