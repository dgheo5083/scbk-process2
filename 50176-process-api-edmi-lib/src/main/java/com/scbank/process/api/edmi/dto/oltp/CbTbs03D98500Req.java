...
@Getter
@Setter
@IntegrationMessage(id = "CbTbs03D98500Req", type = Type.REQUEST, captureSystem = "OLTP", description = "OTP보정 요청 전문")
public class CbTbs03D98500Req implements IMessageObject {
