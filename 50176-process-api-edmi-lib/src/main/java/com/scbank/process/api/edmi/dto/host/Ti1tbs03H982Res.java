...
@Getter
@Setter
@IntegrationMessage(id = "Ti1tbs03H982Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "수수료 납부 취소 응답 전문")
public class Ti1tbs03H982Res implements IMessageObject {
	...
	@MessageField(id = "DeptPersonName", name = "예금주", length = 32, masking = true, maskingType = "04")
	...
	@RepeatedField(repeatType = RepeatType.REFERENCE, repeatCount = "Ti1tbs03H982Res/RCount")
