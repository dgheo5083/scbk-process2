...
@Data
@IntegrationMessage(id = "CbTbs07H59102Res", type = Type.RESPONSE, description = "국세이체 예비처리및관세조회 응답부")
public class CbTbs07H59102Res implements IMessageObject {
    ...
    @MessageField(id = "YI_CustMgmtNum", name = "고객관리번호 (주민등록번호 등)", length = 13, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String YI_CustMgmtNum;

    @MessageField(id = "PayerName", name = "납부자명", length = 42, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String PayerName;

    @MessageField(id = "JsName", name = "징수기관명", length = 42, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String JsName;

    @MessageField(id = "JsKmCode", name = "징수과목코드", length = 7, align = AlignType.RIGHT, padding = StringUtils.ZERO)
    private String JsKmCode;

    @MessageField(id = "JsKmName", name = "징수과목명", length = 42, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String JsKmName;

    @MessageField(id = "JsKGeja", name = "징수관계좌번호", length = 6, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String JsKGeja;

    @MessageField(id = "SoGeJung", name = "소계정", length = 1, align = AlignType.RIGHT, padding = StringUtils.ZERO)
    private String SoGeJung;
    ...
    @MessageField(id = "gojitype", name = "고지서유형", length = 1, align = AlignType.LEFT, padding = StringUtils.SPACE)
    ...
    @MessageField(id = "YOHGNM", name = "회계명", length = 42, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String YOHGNM;

    @MessageField(id = "YOSKNM", name = "소관명", length = 42, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String YOSKNM;

    @MessageField(id = "YOJUSO", name = "납부자주소", length = 82, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String YOJUSO;

    @MessageField(id = "YOSINGO", name = "수입신고번호", length = 15, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String YOSINGO;

    @MessageField(id = "KiilGubun", name = "납기내후구분", length = 1, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String KiilGubun;

    @MessageField(id = "YOSJYN", name = "금액수정허용유무", length = 1, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String YOSJYN;

    @MessageField(id = "YOYUNDE", name = "연대납부대상유무", length = 1, align = AlignType.LEFT, padding = StringUtils.SPACE)
    ...
    @MessageField(id = "TaxActionInfo", name = "청구기관수납인", length = 32, align = AlignType.LEFT, padding = StringUtils.SPACE)
    ...
    @MessageField(id = "YONASENO", name = "납세의무자번호", length = 13, align = AlignType.LEFT, padding = StringUtils.SPACE)
