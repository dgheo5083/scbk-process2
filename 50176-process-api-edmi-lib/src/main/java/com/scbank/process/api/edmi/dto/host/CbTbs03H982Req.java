...
@Getter
@Setter
@IntegrationMessage(id = "CbTbs03H982Req", type = Type.REQUEST, captureSystem = "OLTP", description = "수수료 납부 취소 전문")
public class CbTbs03H982Req implements IMessageObject {
