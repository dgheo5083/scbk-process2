...
@Getter
@Setter
@IntegrationMessage(id = "Ti1ibk01H892Req", type = Type.REQUEST, captureSystem = "OLTP", description = "아이디찾기 요청 전문")
public class Ti1ibk01H892Req implements IMessageObject {
