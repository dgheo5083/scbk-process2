...
@NoArgsConstructor
@AllArgsConstructor
@IntegrationMessage(id = "CbIbk01D93600Res", type = Type.RESPONSE, description = "지연이체 서비스 신청 및 해지 응답 전문")
public class CbIbk01D93600Res implements IMessageObject {
    ...
    @RepeatedField(repeatType = RepeatType.REFERENCE, repeatCount = "CbIbk01D93600Res/YOMSSU")
