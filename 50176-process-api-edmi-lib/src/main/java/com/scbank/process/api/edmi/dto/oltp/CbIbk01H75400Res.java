...
@NoArgsConstructor
@AllArgsConstructor
@IntegrationMessage(id = "CbIbk01H75400Res", type = Type.RESPONSE, description = "마케팅 동의/변경 응답부", captureSystem = "OLTP")
public class CbIbk01H75400Res implements IMessageObject {
