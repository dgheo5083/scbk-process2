...
@Getter
@Setter
@IntegrationMessage(id = "CBIbk01D76400Req", type = Type.REQUEST, captureSystem = "OLTP", description = "모바일OTP 가입 및 해지 조회 요청 전문")
public class CBIbk01D76400Req implements IMessageObject {
