...
@NoArgsConstructor
@AllArgsConstructor
@IntegrationMessage(id = "CbIbk01H75500Req", type = Type.REQUEST, description = "인터넷담보대출허용 요청 전문", captureSystem = "OLTP")
public class CbIbk01H75500Req implements IMessageObject {
