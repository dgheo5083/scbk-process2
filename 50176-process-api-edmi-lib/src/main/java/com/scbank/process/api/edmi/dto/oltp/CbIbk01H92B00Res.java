...
@Data
@IntegrationMessage(id = "CbIbk01H92B00Res", type = Type.RESPONSE, description = "퍼스트알리미 가입조회변경 응답부")
public class CbIbk01H92B00Res implements IMessageObject {
    ...
    @RepeatedField(repeatType = RepeatType.REFERENCE, repeatCount = "CbIbk01H92B00Res/RCount")
