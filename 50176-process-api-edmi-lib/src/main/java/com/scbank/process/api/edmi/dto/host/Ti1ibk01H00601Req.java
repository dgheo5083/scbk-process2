...
@Getter
@Setter
@IntegrationMessage(id = "Ti1ibk01H00601Req", type = Type.REQUEST, captureSystem = "OLTP", description = "본인확인2 요청 전문")
public class Ti1ibk01H00601Req implements IMessageObject {
