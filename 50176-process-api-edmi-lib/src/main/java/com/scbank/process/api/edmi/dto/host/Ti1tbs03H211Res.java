...
@Getter
@Setter
@IntegrationMessage(id = "Ti1tbs03H211Res", type = Type.RESPONSE, description = "즉시이체 응답 전문")
public class Ti1tbs03H211Res implements IMessageObject {
    ...
    @RepeatedField(repeatType = RepeatType.REFERENCE, repeatCount = "Ti1tbs03H211Res/Rcount")
