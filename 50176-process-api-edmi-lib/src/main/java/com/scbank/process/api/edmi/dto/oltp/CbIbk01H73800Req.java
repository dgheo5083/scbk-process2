...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H73800Req", type = Type.REQUEST, captureSystem = "OLTP", description = "증명서>사업소득원천징수영수증")
public class CbIbk01H73800Req implements IMessageObject {
