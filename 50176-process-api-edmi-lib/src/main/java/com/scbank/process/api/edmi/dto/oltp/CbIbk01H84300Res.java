...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H84300Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "CI조회 응답 전문")
public class CbIbk01H84300Res implements IMessageObject {
