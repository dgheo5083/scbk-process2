...
@Data
@IntegrationMessage(id = "CbIbk01H11402Req", type = Type.REQUEST, captureSystem = "OLTP", description = "잔액 조회(신탁)")
public class CbIbk01H11402Req implements IMessageObject {
