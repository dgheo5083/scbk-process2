...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01D00600Req", type = Type.REQUEST, captureSystem = "OLTP", description = "본인확인 요청 전문")
public class CbIbk01D00600Req implements IMessageObject {
	...
	private String RegNo; // _DNFE2E_ _/DNFE2E_ _DVKEY_ _/DVKEY_
	...
	@MessageField(id = "TelCode", name = "전화번호", length = 12)
	...
	private String SafeCardValue1; // _DNFE2E_ _/DNFE2E_ _DVKEY_ _/DVKEY_
	...
	private String SafeCardValue2; // _DNFE2E_ _/DNFE2E_ _DVKEY_ _/DVKEY_
	...
	private String SafeCardValue3; // _DNFE2E_ _/DNFE2E_ _DVKEY_ _/DVKEY_
