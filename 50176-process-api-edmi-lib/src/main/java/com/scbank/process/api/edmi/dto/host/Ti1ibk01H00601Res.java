...
@Getter
@Setter
@IntegrationMessage(id = "Ti1ibk01_H006_01_RES", type = Type.RESPONSE, captureSystem = "OLTP", description = "본인확인2 응답 전문")
public class Ti1ibk01H00601Res implements IMessageObject {
