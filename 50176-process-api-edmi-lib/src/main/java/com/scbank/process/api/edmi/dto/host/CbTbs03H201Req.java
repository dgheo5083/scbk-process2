...
@Getter
@Setter
@IntegrationMessage(id = "CbTbs03H201Req", type = Type.REQUEST, captureSystem = "OLTP", description = "보안매체 검증처리 요청부")
public class CbTbs03H201Req implements IMessageObject {
