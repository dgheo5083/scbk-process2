...
@Data
@IntegrationMessage(id = "Ti1tbs07H421Res", type = Type.RESPONSE, description = "당행 자동이체 신청 응답부")
public class Ti1tbs07H421Res implements IMessageObject {
