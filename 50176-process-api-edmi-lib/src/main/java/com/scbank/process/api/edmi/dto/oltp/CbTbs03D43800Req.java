...
@Getter
@Setter
@IntegrationMessage(id = "CbTbs03D43800Req", type = Type.REQUEST, captureSystem = "OLTP", description = "입출금 해지 본거래 요청 전문")
public class CbTbs03D43800Req implements IMessageObject {
