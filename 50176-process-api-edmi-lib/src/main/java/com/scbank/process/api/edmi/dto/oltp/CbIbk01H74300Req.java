...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H74300Req", type = Type.REQUEST, captureSystem = "OLTP", description = "증명서>연말정산증명서-장기주택저당 차입금이자상환증명서")
public class CbIbk01H74300Req implements IMessageObject {
