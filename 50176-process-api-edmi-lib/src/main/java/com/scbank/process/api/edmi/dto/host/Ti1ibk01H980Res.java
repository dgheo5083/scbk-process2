...
@Getter
@Setter
@IntegrationMessage(id = "Ti1ibk01H980Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "타행타기관인증서목록 응답 전문")
public class Ti1ibk01H980Res implements IMessageObject {
	...
	@RepeatedField(repeatType = RepeatType.REFERENCE, repeatCount = "Ti1ibk01H980Res/RCount")
