...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H92CReq", type = Type.REQUEST, captureSystem = "OLTP", description = "고객정보조회 요청 전문")
public class CbIbk01H92CReq implements IMessageObject {
