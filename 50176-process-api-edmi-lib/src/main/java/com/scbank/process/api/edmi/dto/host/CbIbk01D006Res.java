...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01D006Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "본인확인 응답 전문")
public class CbIbk01D006Res implements IMessageObject {
