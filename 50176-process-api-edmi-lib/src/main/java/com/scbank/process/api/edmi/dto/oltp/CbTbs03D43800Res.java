...
@Getter
@Setter
@IntegrationMessage(id = "CbTbs03D43800Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "입출금 해지 본거래 응답 전문")
public class CbTbs03D43800Res implements IMessageObject {
