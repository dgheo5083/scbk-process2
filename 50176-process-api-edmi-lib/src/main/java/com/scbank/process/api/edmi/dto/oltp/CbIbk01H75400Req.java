...
@NoArgsConstructor
@AllArgsConstructor
@IntegrationMessage(id = "CbIbk01H75400Req", type = Type.REQUEST, description = "마케팅 동의/변경 요청부", captureSystem = "OLTP")
public class CbIbk01H75400Req implements IMessageObject {
