...
@Setter
@ToString
@IntegrationMessage(id = "CbIbk01H50400Res", type = Type.REQUEST, captureSystem = "OLTP", description = "개인정보노출자 조회 응답 전문")
public class CbIbk01H50400Res implements IMessageObject {
