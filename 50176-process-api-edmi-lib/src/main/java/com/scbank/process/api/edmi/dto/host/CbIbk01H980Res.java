...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H980Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "타행타기관인증서목록 응답 전문")
public class CbIbk01H980Res implements IMessageObject {
