...
@Getter
@Setter
@IntegrationMessage(id = "Ti1ibk01H006Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "본인확인 응답 전문")
public class Ti1ibk01H006Res implements IMessageObject {
