...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H44402Req", type = Type.REQUEST, captureSystem = "OLTP", description = "펀드계산서 상세조회")
public class CbIbk01H44402Req implements IMessageObject {
	...
	@MessageField(id = "Index", name = "회차", length = 5, align = AlignType.RIGHT, padding = StringUtils.ZERO)
	private Integer Index;

	@MessageField(id = "TranDate", name = "거래일자", length = 8, align = AlignType.RIGHT, padding = StringUtils.ZERO)
