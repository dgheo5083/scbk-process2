...
@Getter
@Setter
@IntegrationMessage(id = "Ti1ibk01H504Res", type = Type.REQUEST, captureSystem = "OLTP", description = "개인정보노출자 조회 응답 전문")
public class Ti1ibk01H504Res implements IMessageObject {
