...
@Getter
@Setter
@IntegrationMessage(id = "CbTbs03H20100Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "보안매체 검증처리 응답부")
public class CbTbs03H20100Res implements IMessageObject {
