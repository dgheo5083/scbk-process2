...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H89201Req", type = Type.REQUEST, captureSystem = "OLTP", description = "아이디찾기 요청 전문")
public class CbIbk01H89201Req implements IMessageObject {
