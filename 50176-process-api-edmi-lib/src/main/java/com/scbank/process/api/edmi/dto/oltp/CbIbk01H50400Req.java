...
@Setter
@ToString
@IntegrationMessage(id = "CbIbk01H50400Req", type = Type.REQUEST, captureSystem = "OLTP", description = "개인정보노출자 조회 요청 전문")
public class CbIbk01H50400Req implements IMessageObject {
