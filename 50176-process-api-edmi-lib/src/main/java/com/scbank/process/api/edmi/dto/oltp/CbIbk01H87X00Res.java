...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H87X00Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "증명서>예금잔액신청")
public class CbIbk01H87X00Res implements IMessageObject {
    ...
    @MessageField(id = "YOCMFNA", name = "H고객명", length = 32)
    private String YOCMFNA;

    @MessageField(id = "YOENGCMN", name = "영문고객명", length = 30)
    private String YOENGCMN;

    @MessageField(id = "YOCMFENGJSO1", name = "고객영문주소1", length = 45)
    private String YOCMFENGJSO1;

    @MessageField(id = "YOCMFENGJSO2", name = "고객영문주소2", length = 45)
    ...
    @MessageField(id = "YOJMSUPNO", name = "주민사업자번호", length = 14)
    private String YOJMSUPNO;

    @MessageField(id = "YOSEQNO1", name = "잔액증명발급번호", length = 17)
    private String YOSEQNO1;

    @MessageField(id = "YOCMFKORJSO1", name = "H고객한글주소1", length = 72)
    private String YOCMFKORJSO1;

    @MessageField(id = "YOCMFKORJSO2", name = "H고객한글주소2", length = 82)
    ...
    @MessageField(id = "YOSGJNO", name = "수수료출금계좌", length = 11)
    private String YOSGJNO;

    @MessageField(id = "YOPURPOSE", name = "H이용목적", length = 22)
    private String YOPURPOSE;

    @MessageField(id = "YOGIBGYB", name = "기발급여부(Y/N)", length = 1)
    private String YOGIBGYB;
    ...
    @RepeatedField(repeatType = RepeatType.REFERENCE, repeatCount = "CbIbk01H87X00Res/YOJRPGSU")
    ...
    public static class YOGTAOUTINF implements IMessageObject {
        ...
        @MessageField(id = "YOGJWNO2", name = "계좌번호2", length = 11)
        ...
        @MessageField(id = "YOWBSINA", name = "H원본수익자명", length = 14)
        private String YOWBSINA;

        @MessageField(id = "YOIKSINA", name = "H이익수익자명", length = 14)
        ...
        @MessageField(id = "YOWBSUIJENM", name = "원본수익자영문", length = 20)
        private String YOWBSUIJENM;

        @MessageField(id = "YOIIKSUIJENM", name = "이익수익자영문", length = 20)
