...
@Data
@IntegrationMessage(id = "CbIbk01H11306Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "신탁거래내역조회 응답부")
public class CbIbk01H11306Res implements IMessageObject {
    ...
    @MessageField(id = "Curcy", name = "통화코드", length = 3, align = AlignType.LEFT, padding = StringUtils.SPACE)
    private String Curcy;

    @MessageField(id = "DepTrxDetailRecord", name = "출력명세반복부")
    @RepeatedField(repeatType = RepeatType.REFERENCE, repeatCount = "CbIbk01H11306Res/RCount")
    private List<DepTrxDetailRecord> DepTrxDetailRecord;

    @Data
    public static class DepTrxDetailRecord implements IMessageObject {

        @MessageField(id = "TrxDate", name = "", length = 8, align = AlignType.LEFT, padding = StringUtils.SPACE)
        private String TrxDate;

        @MessageField(id = "TrxTime", name = "", length = 6, align = AlignType.LEFT, padding = StringUtils.SPACE)
        private String TrxTime;

        @MessageField(id = "TrxNum", name = "", length = 7, align = AlignType.RIGHT, padding = StringUtils.ZERO)
        private String TrxNum;

        @MessageField(id = "Summary1Part", name = "", length = 3, align = AlignType.RIGHT, padding = StringUtils.ZERO)
        private String Summary1Part;

        @MessageField(id = "Summary1", name = "", length = 8, align = AlignType.LEFT, padding = StringUtils.SPACE)
        private String Summary1;

        @MessageField(id = "Summary2Part", name = "", length = 1, align = AlignType.LEFT, padding = StringUtils.SPACE)
        private String Summary2Part;

        @MessageField(id = "Summary2", name = "", length = 26, align = AlignType.LEFT, padding = StringUtils.SPACE)
        private String Summary2;

        @MessageField(id = "DepPayPart", name = "", length = 1, align = AlignType.LEFT, padding = StringUtils.SPACE)
        private String DepPayPart;

        @MessageField(id = "CancelPart", name = "", length = 1, align = AlignType.LEFT, padding = StringUtils.SPACE)
        ...
        @MessageField(id = "TrxAfterBalSign", name = "", length = 1, align = AlignType.LEFT, padding = StringUtils.SPACE)
        private String TrxAfterBalSign;

        @MessageField(id = "TrxAfterBalance", name = "", length = 13, align = AlignType.RIGHT, padding = StringUtils.ZERO)
        private BigDecimal TrxAfterBalance;

        @MessageField(id = "TrxBranchNum", name = "", length = 3, align = AlignType.RIGHT, padding = StringUtils.ZERO)
        private String TrxBranchNum;

        @MessageField(id = "NoneBankbookTrxYN", name = "", length = 1, align = AlignType.RIGHT, padding = StringUtils.ZERO)
        private String NoneBankbookTrxYN;

        @MessageField(id = "BankName", name = "", length = 7, align = AlignType.LEFT, padding = StringUtils.SPACE)
