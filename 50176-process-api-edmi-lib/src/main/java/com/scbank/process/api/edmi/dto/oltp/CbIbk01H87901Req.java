...
@Getter
@Setter
@IntegrationMessage(id = "CbIbk01H87901Req", type = Type.REQUEST, captureSystem = "OLTP", description = "증명서>인터넷증명서조회-예금잔액증명서목록")
public class CbIbk01H87901Req implements IMessageObject {
    @MessageField(id = "YIUSID", name = "이용자번호", length = 10, masking = true, maskingType = "01")
    private String YIUSID;

    @MessageField(id = "YIJMNO", name = "주민등록번호", length = 13, masking = true, maskingType = "03")
