...
@AllArgsConstructor
@NoArgsConstructor
@IntegrationMessage(id = "CbIbk01H95100Req", type = Type.REQUEST, description = "스피드계좌 조회", captureSystem = "OLTP")
public class CbIbk01H95100Req implements IMessageObject {
