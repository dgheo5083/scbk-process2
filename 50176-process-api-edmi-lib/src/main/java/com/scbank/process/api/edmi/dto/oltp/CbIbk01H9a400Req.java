...
@Data
@IntegrationMessage(id = "CbIbk01H9a400Req", type = Type.REQUEST, captureSystem = "OLTP", description = "자기앞수표 사고신고 요청부")
public class CbIbk01H9a400Req implements IMessageObject {
