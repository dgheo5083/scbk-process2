...
@Getter
@Setter
@IntegrationMessage(id = "CbTbs03H98200Res", type = Type.RESPONSE, captureSystem = "OLTP", description = "수수료 납부 취소 응답 전문")
public class CbTbs03H98200Res implements IMessageObject {
